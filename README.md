...
它适合实体商家、手工艺品牌和电商运营人员使用。默认少提问、自动执行；只有原图无法识别、不同图片疑似属于多个 SKU，或关键信息互相冲突时才暂停确认。
...
6. 逐张调用 ImageGen 生成所需图片。
7. 检查商品一致性、文字准确性、事实依据和电商可用性。
8. 完成交付报告并运行验证脚本。
...
- AI 生成图片不能替代商家的上架审核。
- 正式发布前，应人工确认商品结构、颜色、文字、Logo、尺寸关系和使用方式。
